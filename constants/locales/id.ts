export const id = {
  hero: {
    ...
    cta: {
      ...
      roi: "Cek Simulasi Rugi"
    }
  },
  services: {
    general: {
      categoryLabel: "Kategori Layanan",
      mainTitle: "Solusi Bisnis & Website",
      mainSubtitle: "Pilihan paket lengkap untuk operasional bisnis, branding, dan pemasaran online.",
      bestChoice: "Pilihan Terbaik",
      promo: "PROMO",
      oneTimePayment: "Sekali Bayar (Tanpa Langganan)",
      viewFeatures: "Lihat Detail Fitur"
    },
    'landing-page': {
  ...
  process: {
    title: "Standar Kerja Profesional",
    description: "Saya menerapkan alur kerja terstruktur (SDLC) untuk memastikan sistem yang Anda terima **stabil, aman, dan sesuai kebutuhan** bisnis. Transparan dari kontrak hingga serah terima.",
    steps: [
      {
        id: 1,
    ...
    cta: {
      ready: "Sistem siap dipakai dalam",
      time: "1 - 4 Minggu",
      condition: "(Tergantung Kompleksitas)",
      button: "Mulai Diskusi Project"
    }
  },
  footer: {
    cta: {
  ...
  modal: {
    popular: "Unggulan",
    featureBreakdown: "Bedah Fitur Lengkap:",
    problem: "Masalah:",
    solution: "Solusi Sistem:",
    benefit: "Benefit Bisnis:",
    detailsPreparing: "Detail fitur lengkap sedang disiapkan.",
    getPromo: "Ambil Promo Sekarang",
  ...
  pricingSection: {
    ...
    customApp: "Butuh <strong>Custom App</strong> atau <strong>Integrasi Payment Gateway</strong>?",
    contactMe: "Hubungi saya untuk diskusi teknis & penawaran khusus"
  },
  about: {
    title: "Siapa Agam?",
    ...
    values: [
      ...
      { title: "Cepat Selesai", desc: "Pengerjaan hitungan hari, bukan bulan." },
      { title: "Hak Milik 100%", desc: "Bukan sewa, sistem jadi aset Anda selamanya." },
      { title: "Harga Transparan", desc: "Paket jelas di awal, tanpa biaya tersembunyi." },
      { title: "Solusi Nyata", desc: "Fokus beresin masalah, bukan cuma fitur canggih." }
    ]
  },
  testimonials: {
    title: "Apa Kata Mereka?",
    subtitle: "Kepercayaan adalah mata uang utama dalam bisnis freelance.",
    list: [
      {
        id: 't1',
  ...
  faq: {
    ...
    subtitle: "Hal-hal yang sering ditanyakan klien sebelum memulai kerjasama.",
    list: [
      {
        question: "Berapa biaya untuk membuat sistem/website?",
        answer: "Harga tergantung jenis sistem dan paketnya (<strong>Basic, Premium, Pro</strong>). Setiap paket sudah memiliki fitur jelas agar klien bisa pilih sesuai kebutuhan dan budget. Harga selalu transparan — <strong>tidak ada biaya tersembunyi</strong>."
      },
      {
      ...
      },
      {
        ...
        answer: "<strong>Tidak perlu</strong>. Sistem dibuat sederhana dan <em>user-friendly</em>. Saya juga menyediakan dokumentasi, video tutorial, dan panduan penggunaan."
      },
      {
        question: "Setelah selesai, apakah ada support atau garansi?",
        answer: "<strong>Ada</strong>. Setiap paket memiliki masa garansi berbeda (<strong>2 minggu – 2 bulan</strong>). Bug fix minor dalam masa garansi diberikan gratis."
      },
      {
        question: "Bagaimana proses pembayarannya?",
        answer: "Semua proses jelas, rapi, dan profesional:<ul class='list-disc pl-5 mt-2 space-y-1'><li><strong>DP 40%</strong> sebelum pengerjaan</li><li>Progres update selama proses</li><li><strong>Pelunasan</strong> sebelum serah terima akhir</li></ul>"
      }
    ]
  },
  trustFactors: {
    header: {
      badge: "Jaminan Keamanan & Legalitas",
      title: "Investasi Aman, <br /> <span class='text-transparent bg-clip-text bg-gradient-to-r from-slate-700 to-slate-900 dark:from-slate-200 dark:to-slate-500'>Bisnis Tenang Selamanya.</span>",
      subtitle: "Saya paham kekhawatiran Anda menyewa programmer freelance. Inilah standar keamanan yang saya terapkan agar Anda tidur nyenyak."
    },
    cards: {
      sourceCode: {
        tag: "Best Value",
        title: "100% Hak Milik (Source Code)",
        description: "Aset digital sepenuhnya milik Anda. Tidak ada biaya sewa bulanan, tidak ada enkripsi kode, dan bebas dikembangkan oleh tim lain di masa depan.",
      ...
      server: {
        ...
        description: "Terima beres. Saya urus Domain .com, VPS, SSL Security, hingga email bisnis. Anda tinggal pakai."
      },
      tutorial: {
        title: "Aset Video Tutorial",
        description: "Training karyawan lebih mudah dengan perpustakaan video panduan penggunaan sistem yang bisa ditonton berulang."
      }
    },
    bottomBadges: [
      "Perjanjian Kerjasama (MOU) Jelas",
      "Invoice Resmi",
      "Identitas Developer Terverifikasi"
    ]
  },
  painPoints: {
  ...
  contact: {
    ...
    form: {
      name: { label: "Nama Lengkap", placeholder: "Budi Santoso", error: { required: "Nama wajib diisi", min: "Nama minimal 2 karakter" } },
      phone: { label: "No. WhatsApp", placeholder: "0812-3456-7890", error: { required: "No. WhatsApp wajib diisi", format: "Format nomor tidak valid (min 9 digit)" } },
      email: { label: "Alamat Email", placeholder: "budi@email.com", error: { required: "Email wajib diisi", format: "Format email tidak valid" } },
      service: {
        label: "Jenis Layanan",
        options: [
      ...
      message: { label: "Pesan Anda", placeholder: "Halo Mas Agam, saya butuh sistem POS untuk [Jenis Bisnis]...", error: { required: "Pesan wajib diisi", min: "Pesan terlalu pendek (min. 10 karakter)" } },
      submit: {
        idle: "Kirim Pesan",
      ...
      toast: {
        success: { title: "Pesan Terkirim!", message: "Email Anda telah diterima. Saya akan segera membalasnya." },
        error: { title: "Gagal Mengirim", message: "Mohon cek koneksi atau hubungi via WhatsApp." }
      }
    }
  },
  pricing: {
